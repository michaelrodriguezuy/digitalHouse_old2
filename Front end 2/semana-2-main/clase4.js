...
//MICHAEL
const prueba = document.querySelector('article:nth-child(2)');
console.log(prueba);
...
const divInfoDolar = document.querySelector(".info dolar")

const noticias = document.querySelector(".noticias")

const articulos2 = document.querySelectorAll("main article")
