...
-- 2 
SELECT * FROM facturas WHERE envioVia != 3 AND PaisEnvio = 'USA';
...
-- 4 NroFactura (FacturaID), Producto (ProductoID), Total (PrecioUnitario*Cantidad).
...
-- 2
SELECT * FROM clientes WHERE compania LIKE '_A%';

-- 3 Ciudad, Contacto y renombrarlo como Apellido y Nombre, Titulo y renombrarlo como Puesto WHERE = MADRID
...
-- 7
Describe empleados;
SELECT empleadoId FROM empleados WHERE apellido = 'Buchanan' OR nombre = 'Buchanan';
