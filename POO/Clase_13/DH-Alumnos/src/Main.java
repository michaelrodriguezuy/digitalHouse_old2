public class Main {
    public static void main(String[] args) {
        ...
        ((CuentaCorriente)cc).setSaldo(500);
        System.out.println(((CuentaCorriente)cc).informarSaldo());
        ((CuentaCorriente)cc).gravarImpuesto(0.15);
        //System.out.println(((CuentaCorriente)cc).informarSaldo());

        Cuenta cc1 = new CuentaCorriente();
        ((CuentaCorriente)cc1).setSaldo(1000);

        System.out.println(((CuentaCorriente)cc).compareTo(cc1));
